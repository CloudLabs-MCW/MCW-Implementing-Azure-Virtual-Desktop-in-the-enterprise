...
4.  Extract the files to **C:\Users\<Your Username>\Documents**.
...
-   Select **Run System Clean Up (CleanMgr.exe)** to execute Disk Cleanup.
    ...
    ![After selecting the options above, the preparation selections prior to selecting execute should match this image.](images/jvm13.png)
