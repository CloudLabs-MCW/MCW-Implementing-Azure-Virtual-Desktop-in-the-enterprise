...
2. On the New page, search for **Microsoft Windows 10**. Select **Windows 10 Enterprise multi-session, Version 22H2** and **Create**.
...
3. On the Create a virtual machine page, fill in the required fields and create the VM by selecting **Review + create** and then **Create**.

    - Resource group: **AVD-RG**.
    - Virtual machine name: **avdwin10**.
    ...
    - Password: <inject key="AzureAdUserPassword" />
        ...
        ![This image shows what your configuration should be for the virtual machine image.](images/win10.png "Create virtual machine")
        ...
        ![This image shows that, in the "Create a virtual machine" page within the Azure portal for the Windows 10 VM, allow port 3389 as an inbound port.](images/win10RDP.png "The 'Create a virtual machine' page within the Azure portal for the Windows 10 VM")

4. Select the checkbox to confirm eligible Windows 10 licensing and create the VM by selecting **Review + create**.

    ![This image shows the Windows 10 licensing confirmation and the selection to Review and create.](images/win10Licensing.png "Confirm Windows 10 licensing")
...
5. Once the VM is successfully deployed, go to the resource, and connect using RDP. Sign in using the credentials you supplied when creating the VM.
    ...
    ![This image shows the select connect in the Windows 10 VM overview to RDP to the vm.](images/rdpdownload.png)
...
1. [**Download**](https://minhaskamal.github.io/DownGit/#/home?url=https://github.com/microsoft/MCW-Implementing-Azure-Virtual-Desktop-in-the-enterprise/tree/main/Hands-on%20lab/resources/AVDImageTools) the .zip file to your local workstation.
    ...
    ![This image shows how you will open Microsoft Edge and paste the above link into the browser to download and open the file.](images/linkavdimage.png "Download .zip file")
...
2. **Open** the .zip file on your local workstation. Open the RDP window to your gold image VM. **Save as** the .zip file to the documents folder.
    ...
    ![This image shows how you will open Microsoft Edge and paste the above link into the browser to download and open the file.](images/downloadavdimage.png "Download .zip file")
...
4. Extract the files to **C:\AVDGold**.
...
6. Navigate to "C:\AVDGold\AVDImageTools\Prepare-AVDImage".
...
This will trigger the PowerShell form to launch. Select the appropriate options based on the following input information.
  ...
  ![This image shows that the script will open the AVD golden image preparation window.](images/avdgolden.png "Golden image preparation")
  ...
  - Select **Run System Clean Up (CleanMgr.exe)** to execute Disk Cleanup.
    ...
    ![After selecting the options above, the preparation selections before selecting execute should match this image.](images/avdimageseleect.png "Image preparation selections prior to execute")
...
10. As part of the script, you may be logged off, or the computer may reboot. If so, log back in and rerun the script. This time without OneDrive selected.

11. After the script has been completed, select the Window Start icon and note that Office and Microsoft Teams have been installed.

      ![How to view the newly installed applications.](images/newapplications1.png "Windows view of new applications")

12. Once the script has completed execution, complete these final tasks:
...
3. On the Virtual machines blade, select the VM **avdwin10** you used for your gold image and **select** the name.
...
6. On the Create image wizard, fill in the required fields and Select **Review + create** then select **Create**.
    ...
    - Target image gallery: Create a new, name as **avdmcw**, and click on **ok**.
    - Target image definition: Create a new, name as **avduserimage**, and click on **ok**.
    - Version number: **0.0.1**.
    - Default replication count: **1**.   

    ![This image shows what is displayed on the Create Image blade in Azure.](images/win10image.png "Create Image blade in Azure")
...
8. Locate your image and **Select** the name.
    ...
    ![When you search on images, the image icon is the one you will need to select.](images/findimage1.png "Go to Shared image gallery")
...
9. On the Overview blade for your image, make note of the **Name** field and **Resource group** field. These attributes are needed when you provision your host pools.
    ...
    ![This image shows the information you need to note for the name and resource group.](images/newimage1.png "Windows 10 image that was created")
