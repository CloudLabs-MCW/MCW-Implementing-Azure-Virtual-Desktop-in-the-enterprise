...
4.  On the Create Log Analytics workspace blade, fill in the following information and select **Review + Create**.
    ...
    -    **Resource Group:** East US, this should be the same as the location of your resource group.
...
4.  On the blade for the virtual machine, under **Monitoring**, select **Insights**.
    ...
    ![This image shows that from the domain controller VM, you will select insights under monitoring in the menu.](images/vmmoniter.png "Virtual Machine Insights")

5.  On the Insights blade, select **Enable**. This will initiate a validation check.

    ![This image shows the insights blade, where you will select enable to enable insights on the virtual machine.](images/vmmoniterenable.png "Enable VM Insights")
...
6.  On the Insights setup page, fill in the following information and select **Enable**.
    ...
    - **Log Analytics Workspace:** Select the workspace used in the previous task.

    ![This image shows the enable insights blade, where you will select the Log Analytics workspace and select enable.](images/vmmoniterselect.png "Log Analytics workspace configuration for VM Insights")
