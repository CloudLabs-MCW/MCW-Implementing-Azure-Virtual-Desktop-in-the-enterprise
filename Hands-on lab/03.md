...
2.  Enter a Name for the new file share, select **Hot** Tier, and select **Create**.

    ![This image shows how to give the file share a name and a storage quota in gigabits.](media/storagefiles.png "New File share")
...
11. Select **Access Control (IAM)**, and then select **+ Add** and select **Add role assignment**.
...
12. On the Add role assignment page, search for and select Storage File Data SMB Share Contributor and select **Next**.
...
13. Select **+Select members** and add the **AZF FSLogix Contributor** and **AVD App Hosts** group. Select the **Select** button and then select **Review + assign** and **Review + assign** again.
...
14. Repeat steps 11 - 13 for the remaining two roles.
